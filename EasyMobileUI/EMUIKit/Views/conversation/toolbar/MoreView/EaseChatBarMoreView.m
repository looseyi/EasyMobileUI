...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    [_photoButton setImage:[UIImage imageNamed:@"account_onlineservice_icon_image"] forState:UIControlStateNormal];
    [_photoButton setImage:[UIImage imageNamed:@"account_onlineservice_icon_image"] forState:UIControlStateHighlighted];
    ...
    [_locationButton setImage:[UIImage imageNamed:@"account_onlineservice_icon_photograph"] forState:UIControlStateNormal];
    [_locationButton setImage:[UIImage imageNamed:@"account_onlineservice_icon_photograph"] forState:UIControlStateHighlighted];
    [_locationButton addTarget:self action:@selector(takePicAction) forControlEvents:UIControlEventTouchUpInside];
