...
- (void)_setupSubviews
{
    ...
    _backgroundImageView.image = [EaseBundleImage(@"messageToolbarBg") stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"account_onlineservice_icon_add"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"account_onlineservice_icon_add"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"account_onlineservice_icon_add"] forState:UIControlStateSelected];
    [self.moreButton addTarget:self action:@selector(moreButtonAction:) forControlEvents:UIControlEventTouchUpInside];
  self.moreButton.imageEdgeInsets = UIEdgeInsetsMake(4, 4, 4, 4);
