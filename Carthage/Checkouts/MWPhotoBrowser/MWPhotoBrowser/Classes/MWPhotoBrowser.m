...
- (void)_initialisation {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(handleMWPhotoLoadingDidEndNotification:)
                                               ...
                                               object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(viewWillTransition)
                                                 name:UIApplicationWillChangeStatusBarOrientationNotification
                                               object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(viewDidTransition)
...
{
    if (!_thumbImageView) {
        _thumbImageView = [[UIImageView alloc] initWithImage:self.currentThumbImage];
        _thumbImageView.frame = self.originRect;
